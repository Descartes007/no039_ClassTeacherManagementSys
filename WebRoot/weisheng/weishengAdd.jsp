...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="2" topmargin="9" background='<%=path %>/img/allbg.gif'>
			<form action="<%=path %>/weisheng?type=weishengAdd" name="formAdd" method="post">
				     <table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
						<tr bgcolor="#EEF4EA">
					        <td colspan="3" background="<%=path %>/img/wbg.gif" class='title'><span>宿舍卫生信息检查</span></td>
					    </tr>
						...
						<tr align='center' bgcolor="#FFFFFF" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
								<input type="text" name="riqi" size="20"
						...
						<tr align='center' bgcolor="#FFFFFF" height="22">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						        <input type="text" name="fenshu" size="20"/>(1-3分差 4-6分良 7分以上优秀)
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" height="22">
						    <td width="25%" bgcolor="#FFFFFF" align="right">
						    ...
						    <td width="75%" bgcolor="#FFFFFF" align="left">
						        <textarea rows="5" cols="16" name="shuoming"></textarea>
						    </td>
						</tr>
						<tr align='center' bgcolor="#FFFFFF" height="22">
						    <td width="25%" bgcolor="#FFFFFF" align="right">
